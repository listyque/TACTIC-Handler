...
class Snapshot(SObject):
    ...
    def update_versionless(my, snapshot_mode='current', sobject=None, checkin_type=None, naming=None, custom_path=None):
        ...
        if custom_path:
            lib_dir = "%s/%s" % (custom_path, my.get_relative_dir())
        else:
        ...
        for node in nodes:
            ...
            if custom_path:
                relative_lib_dir = Project.get_project_relative_dir(sobject, versionless, file_object=file_object,
                                                                    file_type=file_type, dir_naming=dir_naming)
                new_lib_dir = "%s/%s" % (custom_path, relative_lib_dir)
            else:
                new_lib_dir = Project.get_project_lib_dir(sobject, versionless, file_object=file_object,
                                                          file_type=file_type, dir_naming=dir_naming)
