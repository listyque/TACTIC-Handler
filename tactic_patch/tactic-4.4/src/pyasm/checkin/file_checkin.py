...
class FileAppendCheckin(FileCheckin):
    ...
    def __init__(my, snapshot_code, file_paths, file_types,  mode=None, keep_file_name=True, source_paths=[], dir_naming=None, file_naming=None, checkin_type='strict', do_update_versionless=True, custom_repo_path=None):
        '''
        ...
        file_naming - explicitly set the file_naming expression to use
        '''
        my.custom_repo_path = custom_repo_path
    ...
    def update_versionless(my, snapshot_mode='current'):
        if my.do_update_versionless:
            return my.snapshot.update_versionless(snapshot_mode, sobject=my.sobject, checkin_type=my.checkin_type, naming=my.naming, custom_path=my.custom_repo_path)
