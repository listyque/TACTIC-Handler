...
class Ui_checkinOptionsGroupBox(object):
    ...
    def retranslateUi(self, checkinOptionsGroupBox):
        checkinOptionsGroupBox.setWindowTitle(QtGui.QApplication.translate("checkinOptionsGroupBox", "GroupBox", None))
        checkinOptionsGroupBox.setTitle(QtGui.QApplication.translate("checkinOptionsGroupBox", "Checkin Options:", None))
        self.groupBox.setTitle(QtGui.QApplication.translate("checkinOptionsGroupBox", "Misc:", None))
        self.saveAsDefaultsPushButton.setText(QtGui.QApplication.translate("checkinOptionsGroupBox", "Apply to All Tabs", None))
        self.pushButton.setText(QtGui.QApplication.translate("checkinOptionsGroupBox", "Edit Filenaming", None))
        self.mayaOptionsGroupBox.setTitle(QtGui.QApplication.translate("checkinOptionsGroupBox", "Maya quick options:", None))
        self.createMayaDirsCheckBox.setText(QtGui.QApplication.translate("checkinOptionsGroupBox", "Create Maya Dirs (worspace.mel)", None))
        self.createPlayblastCheckBox.setText(QtGui.QApplication.translate("checkinOptionsGroupBox", "Create screenshot (playblast)", None))
        self.groupBox_2.setTitle(QtGui.QApplication.translate("checkinOptionsGroupBox", "Saving options:", None))
        self.repositoryLabel.setText(QtGui.QApplication.translate("checkinOptionsGroupBox", "Repository:", None))
        self.checkinMethodLabel.setText(QtGui.QApplication.translate("checkinOptionsGroupBox", "Method:", None))
        self.checkinMethodComboBox.setItemText(0, QtGui.QApplication.translate("checkinOptionsGroupBox", "Preallocate", None))
        self.checkinMethodComboBox.setItemText(1, QtGui.QApplication.translate("checkinOptionsGroupBox", "In-Place", None))
        self.checkinMethodComboBox.setItemText(2, QtGui.QApplication.translate("checkinOptionsGroupBox", "Copy", None))
        self.checkinMethodComboBox.setItemText(3, QtGui.QApplication.translate("checkinOptionsGroupBox", "Move", None))
        self.checkinMethodComboBox.setItemText(4, QtGui.QApplication.translate("checkinOptionsGroupBox", "Upload", None))
        self.updateVersionlessCheckBox.setText(QtGui.QApplication.translate("checkinOptionsGroupBox", "Update versionless", None))
        self.askBeforeSaveCheckBox.setText(QtGui.QApplication.translate("checkinOptionsGroupBox", "Ask before save", None))
