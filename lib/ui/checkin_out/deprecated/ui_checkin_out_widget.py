...
"}")
    ...
    def retranslateUi(self, checkInOutWidget):
        ...
        self.saveDescriprionButton.setText(QtGui.QApplication.translate("checkInOutWidget", "Save description", None))
        ...
        self.processLabel.setText(QtGui.QApplication.translate("checkInOutWidget", "Process:", None))
