...
"")
    ...
    def retranslateUi(self, dropPlateGroupBox):
        dropPlateGroupBox.setWindowTitle(QtGui.QApplication.translate("dropPlateGroupBox", "DropPlate", None))
        dropPlateGroupBox.setTitle(QtGui.QApplication.translate("dropPlateGroupBox", "Drop Files/Folders/Sequences Here:", None))
        self.dropTreeWidget.setSortingEnabled(True)
        self.dropTreeWidget.headerItem().setText(0, QtGui.QApplication.translate("dropPlateGroupBox", "File Name", None))
        self.dropTreeWidget.headerItem().setText(1, QtGui.QApplication.translate("dropPlateGroupBox", "Class/Ext", None))
        self.dropTreeWidget.headerItem().setText(2, QtGui.QApplication.translate("dropPlateGroupBox", "Type", None))
        self.dropTreeWidget.headerItem().setText(3, QtGui.QApplication.translate("dropPlateGroupBox", "File Path", None))
        self.fromDropListCheckBox.setText(QtGui.QApplication.translate("dropPlateGroupBox", "From Droplist", None))
        self.groupCheckinCheckBox.setText(QtGui.QApplication.translate("dropPlateGroupBox", "Group Checkin", None))
        self.keepFileNameCheckBox.setText(QtGui.QApplication.translate("dropPlateGroupBox", "Keep Filename", None))
        self.clearPushButton.setText(QtGui.QApplication.translate("dropPlateGroupBox", "Clear", None))
        self.digSubfoldersCheckBox.setText(QtGui.QApplication.translate("dropPlateGroupBox", "Dig Subfolders", None))
