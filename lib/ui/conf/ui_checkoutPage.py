...
class Ui_checkoutPageWidget(object):
    ...
    def retranslateUi(self, checkoutPageWidget):
        self.checkoutMiscOpitionsGroupBox.setTitle(QtGui.QApplication.translate("checkoutPageWidget", "Misc:", None, QtGui.QApplication.UnicodeUTF8))
        self.doubleClickOpenCheckBox.setText(QtGui.QApplication.translate("checkoutPageWidget", "DoubleClick for Open", None, QtGui.QApplication.UnicodeUTF8))
        self.versionsSeparateCheckoutCheckBox.setText(QtGui.QApplication.translate("checkoutPageWidget", "Display versions separate", None, QtGui.QApplication.UnicodeUTF8))
