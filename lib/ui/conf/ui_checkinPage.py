...
#
# Created: Wed Mar 29 19:32:43 2017
...
"}")
    ...
    def retranslateUi(self, checkinPageWidget):
        self.checkinMiscOptionsGroupBox.setTitle(QtGui.QApplication.translate("checkinPageWidget", "Search Results Options:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.versionsSeparateCheckinCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Display Versions separated:", None, QtGui.QApplication.UnicodeUTF8))
        self.doubleClickOpenCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Shift + DoubleClick for Open", None, QtGui.QApplication.UnicodeUTF8))
        self.askBeforeSaveCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Confirm Saving", None, QtGui.QApplication.UnicodeUTF8))
        self.snapshotDescriptionLimitCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Limit snapshot description preview (symbols):", None, QtGui.QApplication.UnicodeUTF8))
        self.rightVersionsRadioButton.setText(QtGui.QApplication.translate("checkinPageWidget", "Right", None, QtGui.QApplication.UnicodeUTF8))
        self.bottomVersionsRadioButton.setText(QtGui.QApplication.translate("checkinPageWidget", "Bottom", None, QtGui.QApplication.UnicodeUTF8))
        self.snapshotsSavingOptionsGroupBox.setTitle(QtGui.QApplication.translate("checkinPageWidget", "Snapshots Saving Options:", None, QtGui.QApplication.UnicodeUTF8))
        self.repositoryLabel.setText(QtGui.QApplication.translate("checkinPageWidget", "Current Repository:", None, QtGui.QApplication.UnicodeUTF8))
        self.checkinMethodLabel.setText(QtGui.QApplication.translate("checkinPageWidget", "Checkin Method:", None, QtGui.QApplication.UnicodeUTF8))
        self.checkinMethodComboBox.setItemText(0, QtGui.QApplication.translate("checkinPageWidget", "Preallocate", None, QtGui.QApplication.UnicodeUTF8))
        self.checkinMethodComboBox.setItemText(1, QtGui.QApplication.translate("checkinPageWidget", "In-Place", None, QtGui.QApplication.UnicodeUTF8))
        self.checkinMethodComboBox.setItemText(2, QtGui.QApplication.translate("checkinPageWidget", "Copy", None, QtGui.QApplication.UnicodeUTF8))
        self.checkinMethodComboBox.setItemText(3, QtGui.QApplication.translate("checkinPageWidget", "Move", None, QtGui.QApplication.UnicodeUTF8))
        self.checkinMethodComboBox.setItemText(4, QtGui.QApplication.translate("checkinPageWidget", "Upload", None, QtGui.QApplication.UnicodeUTF8))
        self.updateVersionlessCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Update versionless", None, QtGui.QApplication.UnicodeUTF8))
        self.createMayaDirsCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Create Maya Dirs (worspace.mel)", None, QtGui.QApplication.UnicodeUTF8))
        self.createPlayblastCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Create screenshot (playblast)", None, QtGui.QApplication.UnicodeUTF8))
        self.generatePreviewsCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Generate Previews", None, QtGui.QApplication.UnicodeUTF8))
        self.defaultRepoPathsGroupBox.setTitle(QtGui.QApplication.translate("checkinPageWidget", "Repository Paths:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.handoffCheckBox.setText(QtGui.QApplication.translate("checkinPageWidget", "Use handoff dir:", None, QtGui.QApplication.UnicodeUTF8))
