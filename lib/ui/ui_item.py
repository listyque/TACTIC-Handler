...
#
# Created: Fri Jul 08 22:42:59 2016
...
"}")
        ...
        self.childrenToolButton = QtGui.QToolButton(item)
        self.childrenToolButton.setPopupMode(QtGui.QToolButton.MenuButtonPopup)
        self.childrenToolButton.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.childrenToolButton.setAutoRaise(True)
        self.childrenToolButton.setArrowType(QtCore.Qt.NoArrow)
        self.childrenToolButton.setObjectName("childrenToolButton")
        self.gridLayout.addWidget(self.childrenToolButton, 0, 2, 1, 1)
...
"}")
    ...
    def retranslateUi(self, item):
        ...
        self.childrenToolButton.setText(QtGui.QApplication.translate("item", "Children", None, QtGui.QApplication.UnicodeUTF8))
