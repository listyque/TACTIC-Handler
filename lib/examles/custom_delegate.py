...
class MyCustomDelegate(QtGui.QItemDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        textFVersion = index.data(QtCore.Qt.UserRole+6).toString()
        if textFVersion != "":
            ...
            painter.drawText( option.rect.x()+4+one_widthNickName,option.rect.y()+2,option.rect.width(),option.rect.height(), (QtCore.Qt.TextWrapAnywhere|QtCore.Qt.TextWordWrap|QtCore.Qt.AlignTop|QtCore.Qt.AlignLeft), textFVersion)
            painter.restore();
