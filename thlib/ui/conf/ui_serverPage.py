...
class Ui_serverPageWidget(object):
    ...
    def retranslateUi(self, serverPageWidget):
        self.authorizingGroupBox.setTitle(u"Authorization:")
        self.userNameLable.setText(u"User Name:")
        self.tacticServerLable.setText(u"Tactic server:")
        self.usePortalSiteCheckBox.setText(u"Use Portal Site")
        self.savedServerPresetLabel.setText(u"Server presets:")
        self.editServerPresetsPushButton.setText(u"Edit Server Presets")
        self.generateTicketButton.setText(u"Generate New Ticket")
        self.connectToServerButton.setText(u"Check Connection")
        self.tacticStatusLable.setText(u"Connection Status:")
        self.loginStatusLable.setText(u"Ticket Status:")
        self.proxyGroupBox.setTitle(u"Proxy Settings:")
        self.proxyUserNameLabel.setText(u"Login:")
        self.proxyPasswordLabel.setText(u"Password")
        self.proxyServerLabel.setText(u"Proxy Server:")
        self.environmentsGroupBox.setTitle(u"Tactic Environments (Only for TACTIC Team):")
        self.tacticEnvLable.setText(u"Tactic Data dir:")
        self.tacticInstallDirLable.setText(u"Tactic Install dir:")
        self.addTacticEnv.setText(u"Add Tactic environments to system")
